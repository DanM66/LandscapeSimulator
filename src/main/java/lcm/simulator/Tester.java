...
/**
 * Utility class to help with testing. Allows generation a set of Random
 * Gaussian band parameters.  Maybe I'll delete it one day.
 * 
 * @author User
 *
 */
    ...
    private void run(String[] args)
    {
        ...
        for (int ii = 0; ii < ddd.length; ++ii)
        {
            ...
            for (int jj = 0; jj < ddd[ii].length; ++jj)
            {
                ...
                System.out.println(
                        "    <band number = \"" + (jj + 1) + "\" mean = \"" + mean + "\" stdev = \"" + stdev + "\"/>");
            }
